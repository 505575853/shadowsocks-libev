...
# yogurt UDP Request (before encrypted)
# +------+----------+----------+----------+
...
# yogurt UDP Response (before encrypted)
# +------+----------+----------+----------+
# | ATYP | DST.ADDR | DST.PORT |   DATA   |
# +------+----------+----------+----------+
# |  1   | Variable |    2     | Variable |
...
# yogurt UDP Request and Response (after encrypted)
# +-------+--------------+
# |   IV  |    PAYLOAD   |
# +-------+--------------+
# | Fixed |   Variable   |
...
#           request
# `local`   means local server of yogurt
# `remote`  means remote server of yogurt
...
from yogurt import encrypt, obfs, eventloop, lru_cache, common, shell
from yogurt.common import pre_parse_header, parse_header, pack_addr
